...
var ctv_id = url.match(/\/report\/.*\//g);
ctv_id = ctv_id[0].replaceAll(/\/report\//g,"").replaceAll(/\//g,"");
    ...
    <div class="flex-grow flex overflow-x-hidden">
      <div class="flex-grow bg-white dark:bg-gray-900 overflow-y-auto">
        ...
        <div class="sm:p-7 p-4">
          ...
          <p class="text-gray-900 text-lg dark:text-white">Link ref của bạn:</p>
          <input id="url_ref_ctv" onclick="this.select()" value="https://banksodep.glitch.me/ref?id=${ctv_id}"/>
          <br/>
          <div class="doanhthu ">
            ...
            <p>3. Để thanh toán, hãy truy cập <a target="_blank" href="https://forms.gle/hMSCXHErUUxRi7AH8?ref=cuongbokit.blogspot.com">Trang Thanh Toán</a> (T2-T7 8H-21H)</p>
          </div>
        </div>
        <div id="footer">© 2021 by Banksodep </div>
      </div>
    </div>
  </div>
</div>
<style>
#url_ref_ctv{
width:35%;outline: 0;background: #f2f2f2;border: 0;margin: 5px 5px 0px;padding: 10px;box-sizing: border-box;font-size: 12px;
}
@media only screen and (max-width: 480px){
  #url_ref_ctv{width:95%}
}
</style>
`;
